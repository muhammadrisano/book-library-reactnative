    ...
    switch (action.type) {
        ...
        case 'BORROW_USER_FULFILLED':
            return {
                ...
                isLoading: false,
                isFulfilled: true,
                borrowAllUser: action.payload.data.result
            };
        ...
        case 'BORROW_BOOK_USER_REJECTED':
            return {
                ...state,
                isLoading: false,
                isRejected: true,
            };
        case 'BORROW_BOOK_USER_FULFILLED':
            return {
                ...state,
                isLoading: false,
                isFulfilled: true,
                borrowUser: action.payload.data.result
            };
        default:
            return state;
    }
